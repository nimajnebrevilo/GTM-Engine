...
# ── Degraded Mode Tools (only available when APIs are blocked) ────────────

DEGRADED_TOOLS = [
    {
        "name": "save_companies",
        "description": (
            "[Degraded mode only] Save companies discovered via WebSearch to local storage. "
            "Call this after running WebSearch queries and extracting company data. "
            "Pass an array of company objects with: name, domain, description, industry, employee_count, country."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "companies": {
                    ...
                    "description": "Companies found via WebSearch",
                },
            },
            "required": ["companies"],
        },
    },
    {
        "name": "save_signals",
        "description": (
            "[Degraded mode only] Save buying intent signals discovered via WebSearch. "
            "Call this after searching for funding, hiring, leadership changes, etc. "
            "Pass the company domain and an array of signal objects."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "domain": {"type": "string", "description": "Company domain the signals relate to"},
                "signals": {
                    "type": "array",
                    "items": {
                        "type": "object",
                        "properties": {
                            "type": {"type": "string", "description": "Signal type: funding, hiring, leadership_change, expansion, product_launch, acquisition"},
    ...
    },
    {
        "name": "save_contacts",
        "description": (
            "[Degraded mode only] Save contacts discovered via WebSearch/LinkedIn to local storage. "
            "Call this after searching for people at target companies. "
            "Pass an array of contact objects."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
